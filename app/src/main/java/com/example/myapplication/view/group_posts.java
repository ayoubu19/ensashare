...
public class group_posts extends Fragment {
    ...
    public void init(){
          ...
          this.student = new Student("Hamida", "Hamidi", "HamidiHamida", "GI3", profilePiUrl);
          student.setStudentId(student.getUserName());
          postDao = new PostDao("gi2");
          postDaoGet = new PostDao("gi2");
          file = false;
          image = false;
        ...
        postDaoGet.getDatabaseReference().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                group_posts.this.postAdapter = new MyAdapterPosts(group_posts.this.view.getContext(),
                        group_posts.this.postDaoGet.getPosts(), group_posts.this.student, "gi2", group_posts.this.getActivity());
